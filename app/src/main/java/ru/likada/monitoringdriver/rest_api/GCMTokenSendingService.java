...
/**
 * Created by bumur on 28.04.2017.
 */

public class GCMTokenSendingService extends AsyncTask<String, String, String> {

    private static String PARAMETERS;
    private static final String GET_GCM_NOTIFICATION="/notificationToken";
    public AsyncResponseGCMTokenSending delegate=null;
    public GCMTokenSendingService(String mToken, String gcmToken) {
        PARAMETERS="?token="+mToken+"&gcmToken="+gcmToken;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            HttpGet request = new HttpGet(HTTP+IP_ADDRESS+SERVER_CONFIG + "getDrives" + GET_GCM_NOTIFICATION + PARAMETERS);
    ...
    protected void onPostExecute(String result) {
        if(result!=null && !result.isEmpty())
            delegate.processFinishGCMTokenSending(result);
    }
